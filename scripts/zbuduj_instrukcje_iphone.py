...
<section id="instalacja">
  ...
  <ol>
    <li>Otwórz <a href="{APP_STORE}"><b>Strażnika w App Store</b></a> albo wyszukaj w App Store „Strażnik alarm powietrzny”. Aplikacja jest dostępna w App Store w Polsce, Niemczech, Wielkiej Brytanii i Belgii, na Litwie, Łotwie, w Estonii i na Ukrainie.</li>
...
<section id="instalacja">
  ...
  <ol>
    <li>Open <a href="{APP_STORE}"><b>Strażnik on the App Store</b></a> or search the App Store for “Strażnik alarm powietrzny”. The app is available on the App Store in Poland, Germany, the United Kingdom, Belgium, Lithuania, Latvia, Estonia and Ukraine.</li>
