...
ua = (klient.headers or {}).get("User-Agent", "")
sprawdz("Straznik" in ua, "przedstawiamy się w User-Agent")
sprawdz(ua.isascii(), "User-Agent bez polskich znaków — httpx koduje nagłówki latin-1")
