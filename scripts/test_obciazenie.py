...
print("3. bezpiecznik")
ok(load_guard.level_for(79, 500) == 0, "79% RAM VPS → normalnie")
ok(load_guard.level_for(80, 500) == 1, "80% RAM VPS → poziom 1")
ok(load_guard.level_for(40, 2700) == 1, "proces 2700 MB → poziom 1")
ok(load_guard.level_for(40, 2900) == 2, "proces 2900 MB → poziom 2")
ok(load_guard.level_for(91, 500) == 2, "91% RAM VPS → poziom 2")
