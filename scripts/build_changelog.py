...
RELEASES = [
    ...
    ("1.7.74", "23 września 2026", "23 September 2026",
     ...
     ["Czerwony alarm nie wynika już z samej sumy punktów. Oprócz 4 pkt wymaga potwierdzenia: Alertu RCB o treści „znajdź bezpieczne miejsce” albo realnego obiektu uderzeniowego kursem na Polskę — 15 minut od granicy albo bliżej niż 50 km. Drony rozpoznawcze i same doniesienia mediów nie otwierają czerwonego. Gdy region ma 4 pkt bez potwierdzenia, zostaje żółty i aplikacja pisze o tym na karcie.",
      "RCB rozróżnia od 17 września trzy rodzaje komunikatu i Strażnik liczy je osobno: „sytuacja jest monitorowana” 1,5 pkt, „trwa zmasowany atak… reaguj na sygnały alarmowe” 3 pkt, „zagrożenie atakiem z powietrza, znajdź bezpieczne miejsce” 4,5 pkt. Kolejny alert nie sumuje się z poprzednim: liczy się bieżący, a nadwyżka mocniejszego gaśnie w 10 minut.",
      "Artykuł, który powtarza treść Alertu RCB, nie dokłada już drugich punktów — wcześniej wystarczyło inne odmienienie słowa, żeby uznać go za niezależne potwierdzenie.",
      "Doniesienie o zdarzeniu nad Bałtykiem nie punktuje już województwa tylko dlatego, że napisał o nim tamtejszy portal.",
      "Drony rozpoznawcze ważą 0,15 zamiast 0,5 pkt. W zamian trzy różne obiekty lecące na Polskę w 15 minut (bliżej niż 150 km) dokładają wspólnie 0,5 pkt — dzięki temu żółty nadal zapala się przed Alertem RCB.",
      "Czas dolotu liczony jest także dla pozycji rejonowych, więc warunek czerwonego alarmu ma na czym się oprzeć."],
     ["A red alert no longer follows from the score alone. Besides 4 points it needs a confirmation: an RCB alert saying “find a safe place”, or a real strike object heading at Poland — 15 minutes from the border or closer than 50 km. Reconnaissance drones and media reports alone do not open red. With 4 points and no confirmation the province stays yellow, and the app says so on the card.",
      "Since 17 September RCB distinguishes three kinds of message, and Strażnik scores them separately: “the situation is being monitored” 1.5 pts, “a massive attack is under way… react to alarm signals” 3 pts, “threat of an air attack, find a safe place” 4.5 pts. A later alert does not add to the earlier one: the current one counts, and the surplus of a stronger one fades within 10 minutes.",
      "An article repeating the wording of an RCB alert no longer adds a second score — previously a different inflection of one word was enough to treat it as independent confirmation.",
      "A report about an event over the Baltic no longer scores a province just because a local outlet wrote about it.",
      "Reconnaissance drones weigh 0.15 instead of 0.5 pts. In exchange, three different objects heading at Poland within 15 minutes (closer than 150 km) add 0.5 pts together — so yellow still fires before the RCB alert.",
      "Time to the border is now computed for area-only positions too, so the red-alert condition has something to stand on."],
     []),
