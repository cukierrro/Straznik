...
;
  ...
  function viewZasady() {
    ...
    return `<div class="row view-head"><h2 class="grow">${T("Zasady Groty")}</h2>
      ...
      <p>${T("W publicznym zbiorze PSP część punktów ma współrzędne postawione obok budynku, którego dotyczą. Sprawdziliśmy to na danych z całej Polski: <b>1083 punktów</b> (1,3%) nie stoi na żadnym budynku. Przy 668 z nich budynek jest w promieniu 30 m (najczęściej blok — szpilka wylądowała na podwórku, parkingu albo trawniku), przy 256 w 30–60 m, przy 110 w 60–150 m, a <b>49 punktów nie ma żadnego budynku w promieniu 150 m</b> — tam szpilka wskazuje pole, las albo miejsce poza miejscowością z adresu.")}</p>
